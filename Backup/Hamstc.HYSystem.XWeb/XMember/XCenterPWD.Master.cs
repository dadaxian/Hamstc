    ...
    public partial class XCenterPWD :MemberMaster
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox1.Text.Length>0 || TextBox2.Text.Length>0 || TextBox3.Text.Length>0)
            {
                ...
                else if (TextBox1.Text!=CurrMember.LoginPWD) msg="原来密码有误";
                else
                {
                    CurrMember.LoginPWD=TextBox2.Text;
            ...
            if (TextBox4.Text.Length > 0 || TextBox5.Text.Length > 0 || TextBox6.Text.Length > 0)
            {
                ...
                else if (TextBox5.Text != TextBox6.Text) msg = "确认密码有误";
                else if (TextBox4.Text != CurrMember.ManagePWD) msg = "原来密码有误";
                else
                {
                    CurrMember.ManagePWD = TextBox5.Text;
                    CurrMember.UpdateTime = DateTime.Now;
